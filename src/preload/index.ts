...
const testChannels = [
  ...
  'kac:list', 'kac:list_for_parent', 'kac:get', 'kac:create', 'kac:update', 'kac:delete',
  'kac:add_item', 'kac:update_item', 'kac:remove_item', 'kac:reorder_items',
  'kac:extract_from_parent',
  'estimate:list', 'estimate:list_for_parent', 'estimate:get', 'estimate:create',
  'estimate:update', 'estimate:resolve', 'estimate:reopen', 'estimate:delete',
