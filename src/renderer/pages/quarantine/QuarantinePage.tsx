...
import { Bug, RefreshCw, Loader2, Unlock, ShieldCheck, AlertOctagon } from 'lucide-react'
...
type Tab = 'quarantined' | 'all' | 'rules'
...
export function QuarantinePage() {
  ...
  async function loadAll() {
    setError(null)
    try {
      const [r, q, f, rs] = await Promise.all([
      ...
      ]) as [RunRow | null, FlaggedRow[], FlaggedRow[], RuleDef[]]
      setRun(r); setQuarantined(q); setFlagged(f); setRules(rs)
    } catch (err) {
